...
function changeDataShown(){
  var e = document.getElementById("selectPlayOff");
  var value = e.options[e.selectedIndex].value;
  switch (value) {
    case "perGame":
        var path = '/data/playoffpergame.json';
      break;
    case "totals":
        var path = '/data/playofftotals.json';
      break;
    case "per36Minutes":
        var path = '/data/playoffper36Minutes.json';
    break;
    case "per100Poss":
        var path = '/data/playoffper100Poss.json';
    break;
    case "advanced":
        var path = '/data/playoffadvance.json';
    break;
    default:
       var path = '/data/playoffpergame.json';
      break;
